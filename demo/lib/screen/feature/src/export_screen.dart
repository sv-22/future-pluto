    ...
    return PlutoExampleScreen(
      ...
      body: PlutoGrid(
        ...
        createHeader: (stateManager) =>
            _HeaderExportScreen(stateManager: stateManager),
...
class _HeaderExportScreen extends StatefulWidget {
  const _HeaderExportScreen({
  ...
  @override
  State<_HeaderExportScreen> createState() => _HeaderExportScreenState();
}

class _HeaderExportScreenState extends State<_HeaderExportScreen> {
