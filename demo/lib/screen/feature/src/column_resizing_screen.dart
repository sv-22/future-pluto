  ...
  Widget build(BuildContext context) {
    return PlutoExampleScreen(
      ...
      body: PlutoGrid(
        ...
        createHeader: (stateManager) => _HeaderColumnResizing(
...
class _HeaderColumnResizing extends StatefulWidget {
  const _HeaderColumnResizing({
  ...
  @override
  State<_HeaderColumnResizing> createState() => _HeaderColumnResizingState();
}

class _HeaderColumnResizingState extends State<_HeaderColumnResizing> {
